            ...
            return Builder<UserRegistrationHistoryListAttributes>()
                ...
                .summary(
                    Builder<StatSummaryAttributes>()
                        ...
                        .mean(statValues.length && statValues.map((item) => item.value)
                            .reduce((acc, item) => acc + item, 0)/statValues.length)
            ...
            .summary(
                Builder<StatSummaryAttributes>()
                    ...
                    .sum(newValues.map((item) => item.value)
                        .reduce((acc, item) => acc + item))
                    .mean(statValues.length && newValues.map((item) => item.value)
                        .reduce((acc, item) => acc + item, 0)/newValues.length)
